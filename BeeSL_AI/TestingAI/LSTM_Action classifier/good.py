...
labels_one_hot = to_categorical(labels, num_classes=23)
...
model = models.Sequential([
    ...
    layers.Dense(23, activation='softmax')  # Adjust num_classes according to your dataset
])
#'''
'''
model = Sequential([
...
model.save("Test_Model2_noBird.h5")